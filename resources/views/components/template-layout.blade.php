...
@php
    $defaultNavItems = [
        ...
        ['label' => 'Benachrichtigungen', 'href' => route('apps.template.settings.notifications'), 'icon' => 'bell', 'description' => 'Benachrichtigungen dieser App konfigurieren', 'buttonText' => 'Benachrichtigungen öffnen'],
        ['label' => 'Bedienungsanleitung', 'href' => route('apps.template.manual'), 'icon' => 'book-open', 'description' => 'Ausführliche Anleitung zur App', 'buttonText' => 'Anleitung öffnen'],
